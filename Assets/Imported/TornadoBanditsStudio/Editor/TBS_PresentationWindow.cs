...
namespace TornadoBanditsStudio
{
	public class TBS_PresentationWindow : EditorWindow
	{
		...
		private static void InitializeWindow()
		{
			...
			var presentationWindow = (TBS_PresentationWindow) GetWindowWithRect(typeof(TBS_PresentationWindow),
				new Rect(0, 0, 512, 600), true, "Package Presentation");
		...
		private void OnGUI()
		{
			...
			var editorWindowTexture = new Texture2D(1, 1, TextureFormat.RGBA32, false);
		...
		private static Texture2D facebookLogo;
		private static Texture2D mailLogo;
		private static Texture2D siteLogo;
		private static Texture2D docLogo;

		#endregion

		#region URLS REGIONS

		private static readonly string FACEBOOK_URL = "http://tinyurl.com/tornadobanditsstudio";
		private static readonly string MAIL_URL = "mailto:tornadobanditsstudio@gmail.com";
		private static readonly string SITE_URL = "www.tornadobanditsstudio.com";
		private static readonly string DOC_URL = "https://tinyurl.com/lowpolyfreepack";
